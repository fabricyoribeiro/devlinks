...
import {} from '../../services/fireBseConnection.js'
...
import { db } from '../../services/fireBseConnection.js'
...
export default function Admin(){
  ...
  async function handleRegister(e){
    ...
    .then(() => {
      setNameInput('')
      setUrlInput('')
      console.log('link registered successfull')
    })
    .catch((error) => {
      console.log('erro registered')
